let div = {
	...
	'湖北' : ['十堰','武汉','黄石','宜昌','襄樊','鄂州','荆门','孝感','荆州','黄冈','咸宁','随州','恩施','仙桃','潜江','天门','神农架'],
...
let distros = {
	'华北': [
		{
			coord: coord,
			title: '湖北人杰特种汽车（华北）科技有限公司',
			addr: '十堰市张湾区工业新区彩虹路6号',
			tel: '王绍华 18071360222'
		},
	],
	'十堰': [
...
if (ulTag) var liTag = ulTag.firstElementChild;
...
function appendDistros() {
	...
	if (! distrosOfCity) {
	    let selectedProv = selectTagProv.value;
	    distrosOfCity = distros[div[selectedProv][0]];
	}
...
/* appiontment form cities selector */
